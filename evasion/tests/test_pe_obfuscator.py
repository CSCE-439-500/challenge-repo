...
class TestPECodeEncryption:
    ...
    def test_encryption_with_env_key(self, mock_pe_data):
        ...
        with patch.dict(os.environ, {"REDTEAM_MODE": "true", "ALLOW_ACTIONS": "true", "ENCRYPTION_KEY": "test_key_12345"}):
            from rt_evade.pe.encryption import EncryptionConfig
            config = PEObfuscationConfig(
                enable_mimicry=False,
                enable_string_obfuscation=False,
...
class TestPEImportManipulation:
    ...
    def test_import_manipulator_initialization(self):
        ...
        from rt_evade.pe.import_manipulator import PEImportManipulator, ImportManipulationConfig
    ...
    def test_generate_fake_imports(self):
        ...
        with patch.dict(os.environ, {"REDTEAM_MODE": "true"}):
            ...
            assert all(not imp.is_used for imp in fake_imports)  # Should be marked as unused
    ...
    def test_generate_dead_code_functions(self):
        ...
        with patch.dict(os.environ, {"REDTEAM_MODE": "true"}):
            ...
            assert all(any(pattern in func for pattern in ["__deadcode_", "__unused_", "__helper_", "__check_", "__get_", "__init_", "__cleanup_", "__validate_", "__process_", "__verify_"])
...
class TestPEDetectionMitigation:
    ...
    def test_detection_mitigation_initialization(self):
        ...
        from rt_evade.pe.detection_mitigation import PEDetectionMitigation, DetectionMitigationConfig
    ...
    def test_common_section_names_database(self):
        ...
        with patch.dict(os.environ, {"REDTEAM_MODE": "true"}):
            ...
            expected_categories = ["standard", "benign", "suspicious", "system", "development"]
            for category in expected_categories:

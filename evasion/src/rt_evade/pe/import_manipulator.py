...
class PEImportManipulator:
    ...
    def _load_benign_apis(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            "user32.dll": [
                "GetDesktopWindow", "GetWindow", "GetParent", "GetWindowTextA",
                "GetWindowTextW", "SetWindowTextA", "SetWindowTextW", "GetWindowRect",
                "SetWindowPos", "ShowWindow", "UpdateWindow", "InvalidateRect",
                "InvalidateRgn", "RedrawWindow", "GetDC", "ReleaseDC", "GetWindowDC",
                "BeginPaint", "EndPaint", "GetMessageA", "GetMessageW", "PeekMessageA",
                "PeekMessageW", "TranslateMessage", "DispatchMessageA", "DispatchMessageW",
                "PostMessageA", "PostMessageW", "SendMessageA", "SendMessageW",
                "RegisterClassA", "RegisterClassW", "RegisterClassExA", "RegisterClassExW",
                "CreateWindowA", "CreateWindowW", "CreateWindowExA", "CreateWindowExW",
                "DestroyWindow", "DefWindowProcA", "DefWindowProcW", "LoadCursorA",
                "LoadCursorW", "LoadIconA", "LoadIconW", "LoadImageA", "LoadImageW",
                "GetSystemMetrics", "GetCursorPos", "SetCursorPos", "ShowCursor",
                "SetCursor", "LoadCursorFromFileA", "LoadCursorFromFileW"
            ],
            "gdi32.dll": [
                "CreateCompatibleDC", "CreateCompatibleBitmap", "SelectObject",
                "DeleteObject", "DeleteDC", "BitBlt", "StretchBlt", "GetPixel",
                "SetPixel", "GetDeviceCaps", "CreateFontA", "CreateFontW",
                "CreateFontIndirectA", "CreateFontIndirectW", "GetTextExtentPoint32A",
                "GetTextExtentPoint32W", "TextOutA", "TextOutW", "ExtTextOutA",
                "ExtTextOutW", "DrawTextA", "DrawTextW", "GetTextMetricsA",
                "GetTextMetricsW", "GetStockObject", "GetObjectA", "GetObjectW",
                "CreatePen", "CreateSolidBrush", "CreateHatchBrush", "CreatePatternBrush",
                "CreateDIBitmap", "CreateDIBSection", "GetDIBits", "SetDIBits"
            ],
            "advapi32.dll": [
                "RegOpenKeyExA", "RegOpenKeyExW", "RegCloseKey", "RegQueryValueExA",
                "RegQueryValueExW", "RegSetValueExA", "RegSetValueExW", "RegDeleteValueA",
                "RegDeleteValueW", "RegEnumKeyExA", "RegEnumKeyExW", "RegEnumValueA",
                "RegEnumValueW", "RegCreateKeyExA", "RegCreateKeyExW", "RegDeleteKeyA",
                "RegDeleteKeyW", "RegFlushKey", "RegLoadKeyA", "RegLoadKeyW",
                "RegSaveKeyA", "RegSaveKeyW", "RegRestoreKeyA", "RegRestoreKeyW",
                "RegConnectRegistryA", "RegConnectRegistryW", "RegUnLoadKeyA", "RegUnLoadKeyW",
                "OpenSCManagerA", "OpenSCManagerW", "OpenServiceA", "OpenServiceW",
                "StartServiceA", "StartServiceW", "ControlService", "QueryServiceStatus",
                "QueryServiceConfigA", "QueryServiceConfigW", "ChangeServiceConfigA",
                "ChangeServiceConfigW", "CreateServiceA", "CreateServiceW",
                "DeleteService", "CloseServiceHandle", "LookupAccountNameA",
                "LookupAccountNameW", "LookupAccountSidA", "LookupAccountSidW",
                "ConvertSidToStringSidA", "ConvertSidToStringSidW", "ConvertStringSidToSidA",
                "ConvertStringSidToSidW", "GetTokenInformation", "SetTokenInformation",
                "AdjustTokenPrivileges", "LookupPrivilegeValueA", "LookupPrivilegeValueW",
                "LookupPrivilegeNameA", "LookupPrivilegeNameW", "OpenProcessToken",
                "OpenThreadToken", "GetTokenInformation", "SetTokenInformation"
            ],
            "ole32.dll": [
                "CoInitialize", "CoUninitialize", "CoInitializeEx", "CoGetMalloc",
                "CoCreateInstance", "CoCreateInstanceEx", "CoGetClassObject",
                "CoRegisterClassObject", "CoRevokeClassObject", "CoGetObject",
                "CoGetInterfaceAndReleaseStream", "CoMarshalInterface",
                "CoUnmarshalInterface", "CoMarshalHresult", "CoUnmarshalHresult",
                "CoGetCallerTID", "CoGetCurrentProcess", "CoGetCurrentLogicalThreadId",
                "CoGetApartmentType", "CoGetContextToken", "CoGetDefaultContext",
                "CoGetMalloc", "CoGetMarshalSizeMax", "CoGetPSClsid", "CoGetStandardMarshal",
                "CoGetStdMarshalEx", "CoGetTreatAsClass", "CoGetUnmarshalClass",
                ...
                "CoRegisterSurrogate", "CoReleaseMarshalData", "CoResumeClassObjects",
                "CoRevertToSelf", "CoRevokeClassObject", "CoSetCancelObject", "CoSetProxyBlanket",
                "CoSuspendClassObjects", "CoSwitchCallContext", "CoTaskMemAlloc",
                "CoTaskMemFree", "CoTaskMemRealloc", "CoUninitialize", "CoUnmarshalHresult",
                "CoUnmarshalInterface", "CoUnmarshalInterThreadInterfaceInStream",
                "CoWaitForMultipleHandles", "CoWaitForMultipleObjects"
            ],
            "shell32.dll": [
                "ShellExecuteA", "ShellExecuteW", "ShellExecuteExA", "ShellExecuteExW",
                "FindExecutableA", "FindExecutableW", "Shell_NotifyIconA", "Shell_NotifyIconW",
                "SHGetFileInfoA", "SHGetFileInfoW", "SHGetPathFromIDListA", "SHGetPathFromIDListW",
                "SHGetSpecialFolderPathA", "SHGetSpecialFolderPathW", "SHGetSpecialFolderLocation",
                "SHGetFolderPathA", "SHGetFolderPathW", "SHGetFolderLocation", "SHGetKnownFolderPath",
                "SHGetKnownFolderIDList", "SHGetDesktopFolder", "SHGetMalloc", "SHGetInstanceExplorer",
                "SHGetDataFromIDListA", "SHGetDataFromIDListW", "SHGetNewLinkInfoA", "SHGetNewLinkInfoW",
                "SHGetSettings", "SHSetSettings", "SHGetFolderPathAndSubDirA", "SHGetFolderPathAndSubDirW",
        ...
        try:
            ...
            for dll_name, functions in imports.items():
                for func_name in functions:
                    import_entries.append(ImportEntry(
                        dll_name=dll_name,
    ...
    def generate_fake_imports(self, existing_imports: List[ImportEntry]) -> List[ImportEntry]:
        ...
        existing_functions = {(imp.dll_name.lower(), imp.function_name.lower()) 
        ...
        for dll_name in available_dlls:
            ...
            for func_name in selected_functions:
                ...
                if (dll_name.lower(), func_name.lower()) not in existing_functions:
                    fake_imports.append(ImportEntry(
                        dll_name=dll_name,
                        function_name=func_name,
    ...
    def create_import_manipulation_plan(self, pe_data: bytes) -> Dict[str, Any]:
        ...
        logger.info("action=import_manipulation_plan_created existing=%d fake=%d dead=%d",
                   len(existing_imports), len(fake_imports), len(dead_code))
        
        return plan
    
    def get_manipulation_report(self, original_imports: List[ImportEntry], 
                              manipulated_imports: List[ImportEntry]) -> Dict[str, Any]:
        ...
        report = {
            ...
            "fake_imports_added": len([imp for imp in manipulated_imports if not imp.is_used]),
            "dll_diversity": len(set(imp.dll_name for imp in manipulated_imports)),
            "original_dll_diversity": len(set(imp.dll_name for imp in original_imports))
        }

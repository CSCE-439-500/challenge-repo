...
class PEStringObfuscator:
    ...
    def _load_suspicious_patterns(self) -> List[str]:
        ...
        return [
            ...
            "nslookup.exe", "arp.exe", "route.exe", "telnet.exe",
            "ftp.exe", "tftp.exe", "nc.exe", "netcat.exe"
        ]
    ...
    def _obfuscate_string(self, string: str) -> str:
        ...
        if method == "base64":
            ...
            logger.warning("action=unknown_obfuscation_method method=%s using_base64", method)
            return self._base64_obfuscate(string)
    ...
    def get_string_obfuscation_report(self, original_data: bytes, obfuscated_data: bytes) -> Dict[str, Any]:
